    ...
    <script>
        ...
        function getCartHtml(productArray) {
            ...
            for (var i = 0; i < cartCount; i++) {
                ...
                let productAvailableCount = product.productAvailableCount;
                ...
                cartHtmal = cartHtmal + '<div class="number"><span class="minus" id="minus'+productId+'" onclick="minusCart(' + productId + ', '+productAvailableCount+')" >&minus;</span><input type="number" readonly min="1" id="' + productId + '" data-productId="' + productId + '" value="' + productCount + '" maxlength="10" /><span class="plus" id="plus'+productId+'" onclick="plusCart(' + productId + ', '+productAvailableCount+')">&plus;</span></div><span id="'+productId+'error"></span>';

                // cartHtmal = cartHtmal + '<div class="number"><span class="minus" id="minus'+productId+'" onclick="minusCart(' + productId + ', '+productAvailableCount+')" >&minus;</span><input type="number" readonly min="1" id="' + productId + '" data-productId="' + productId + '" value="' + productCount + '" maxlength="10" onchange="updateCartCount(' + productId + ', '+productAvailableCount+')" /><span class="plus" id="plus'+productId+'" onclick="plusCart(' + productId + ', '+productAvailableCount+')">&plus;</span></div><span id="'+productId+'error"></span>';
        ...
        function updateCartCount(productId, availableCount) {
            ...
            }else if(newproductCount <= availableCount){
        ...
        function minusCart(productId, availableCount) {
            let plusId = 'plus'+productId;
            let minusId = 'minus'+productId;
