    ...
    <script>
        ...
        function getCartHtml(productArray) {
            ...
            for (var i = 0; i < cartCount; i++) {
                ...
                cartHtmal = cartHtmal + '<div class="number"><span class="minus" onclick="minusCart(' + productId + ', '+productAvailableCount+')" >&minus;</span><input type="number" readonly min="1" id="' + productId + '" data-productId="' + productId + '" value="' + productCount + '" maxlength="10" onchange="updateCartCount(' + productId + ', '+productAvailableCount+')" /><span class="plus" onclick="plusCart(' + productId + ', '+productAvailableCount+')">&plus;</span></div><span id="'+productId+'error"></span>';
